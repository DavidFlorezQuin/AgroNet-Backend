...
builder.Logging.AddConsole(); // Asegura que el logging de consola est� habilitado
...
{
    cfg.AddProfile<MappingProfile>(); // A�ade el perfil de mapeo
});

builder.Services.AddAutoMapper(typeof(MappingProfile)); // O el ensamblado donde est� definido MappingProfile
...
// Aseg�rate de usar CORS antes de Authorization y otros middlewares
